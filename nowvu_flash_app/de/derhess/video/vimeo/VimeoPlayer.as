package de.derhess.video.vimeo {
	...
	public class VimeoPlayer extends Sprite {
		...
		public function VimeoPlayer(clip_id:int, w:int, h:int) {
			...
			Security.allowDomain("http://api.vimeo.com");
			
			var loader:Loader = new Loader();
			var request:URLRequest = new URLRequest("http://api.vimeo.com/moogaloop_api.swf?clip_id=" + clip_id + "&width=" + w + "&height=" + h + '&fullscreen=0');
